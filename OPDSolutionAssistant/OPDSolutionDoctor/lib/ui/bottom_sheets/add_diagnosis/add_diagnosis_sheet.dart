...
class AddDiagnosisSheet extends StackedView<PatientViewModel>
    with $PatientView {
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return filteredChips.isEmpty &&
                            ...
                            ? buildChipItem(diagnosisItems[index], context,
                                index, viewModel)
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  contentPadding: const EdgeInsets.symmetric(
                      vertical: 21, horizontal: 15.0),
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(16)),
                  hintText: 'Add custom diagnosis here'),
  ...
  Widget buildChipItem(name, context, index, PatientViewModel viewModel) {
    ...
    return InkWell(
      onTap: () {
        viewModel.onDiagnosisChipSelect(
            selectedDiagnosisList.contains(name) ? false : true, name, index);
      },
      child: Container(
          decoration: BoxDecoration(
