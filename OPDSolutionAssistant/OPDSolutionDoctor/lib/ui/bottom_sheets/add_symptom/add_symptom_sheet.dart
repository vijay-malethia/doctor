...
import '/ui/views/patient/patient_viewmodel.dart';

class AddSymptomSheet extends StackedView<PatientViewModel> with $PatientView {
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return filteredChips.isEmpty &&
                            ...
                            ? buildChipItem(
                                symptomsItems[index], context, index, viewModel)
        ...
        Expanded(
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: 'Add custom symptom here'),
  ...
  Widget buildChipItem(name, context, index, PatientViewModel viewModel) {
    ...
    return InkWell(
      onTap: () {
        viewModel.onChipSelect(
            selectedSymptomsList.contains(name) ? false : true, name, index);
      },
      child: Container(
          decoration: BoxDecoration(
