...
extension ValueProperties on FormViewModel {
  ...
  set otpDigit1Value(String? value) {
    this.setData(
      this.formValueMap..addAll({OtpDigit1ValueKey: value}),
    );
  ...
  set otpDigit2Value(String? value) {
    this.setData(
      this.formValueMap..addAll({OtpDigit2ValueKey: value}),
    );
  ...
  set otpDigit3Value(String? value) {
    this.setData(
      this.formValueMap..addAll({OtpDigit3ValueKey: value}),
    );
  ...
  set otpDigit4Value(String? value) {
    this.setData(
      this.formValueMap..addAll({OtpDigit4ValueKey: value}),
    );
